...
public class JVXParserUtil {
  ...
  private static final TokenSet TRAILING_COMMENT_SET = TokenSet.orSet(
    TokenSet.create(JVXElementType.PACKAGE_STATEMENT),
  ...
  public static PsiBuilder createBuilder(final ASTNode chameleon) {
    ...
    if (!language.isKindOf(JVXLanguage.INSTANCE)) language = JVXLanguage.INSTANCE;
