...
import io.astrolib.jvx.psi.stub.elements.JVXStubPsiElement;
 ...
 * @author skeswa
 */
public class PsiClassImpl extends JVXStubPsiElement<PsiClassStub<?>> implements PsiExtensibleClass, PsiQualifiedNamedElement, Queryable {
    private static final Logger LOG = Logger.getInstance("#PsiClassImpl");

    private final ClassInnerStuffCache myInnersCache = new ClassInnerStuffCache(this);
    private volatile String myCachedName;

    public PsiClassImpl(final PsiClassStub stub) {
        this(stub, JVXStubElementTypes.CLASS);
    }
    ...
    public PsiModifierList getModifierList() {
        ...
        return getRequiredStubOrPsiChild(JVXStubElementTypes.MODIFIER_LIST);
    }
    ...
    public PsiReferenceList getExtendsList() {
        // TODO(skeswa): implement this
        return getStubOrPsiChild(JVXStubElementTypes.EXTENDS_LIST);
    }

    @Override
    public PsiReferenceList getImplementsList() {
        // TODO(skeswa): implement this
        return getStubOrPsiChild(JVXStubElementTypes.IMPLEMENTS_LIST);
    }
    ...
    public List<PsiClass> getOwnInnerClasses() {
        return Arrays.asList(getStubOrPsiChildren(JVXStubElementTypes.CLASS, PsiClass.ARRAY_FACTORY));
    }
    ...
    public PsiClassInitializer[] getInitializers() {
        // TODO(skeswa): implement this
        return getStubOrPsiChildren(JVXStubElementTypes.CLASS_INITIALIZER, PsiClassInitializer.ARRAY_FACTORY);
    }
    ...
    public PsiTypeParameterList getTypeParameterList() {
        // TODO(skeswa): implement this
        return getRequiredStubOrPsiChild(JVXStubElementTypes.TYPE_PARAMETER_LIST);
    }
